...
export class FullArmorSqlTableDao extends Dao<FullArmor, any> {
    ...
    async createItem(item: FullArmor): Promise<void> {
        try {
            ...
            console.error(`Error creating FullArmor item ${item.name.rus}:`, error);
            throw error;
        }
    }
    ...
    async updateItem(item: FullArmor): Promise<void> {
        try {
            ...
            console.error(`Error updating FullArmor item ${item.name.rus}:`, error);
            throw error;
        }
    }
    ...
    async mapSqlValues(sqlValues: SqlValue[]): Promise<FullArmor> {
        try {
            ...
            console.error('Error mapping SQL values to FullArmor:', error);
            throw error;
        }
    }
}
