...
export class FullArtifactSqlTableDao extends Dao<FullArtifact, any> {
    ...
    async createItem(item: FullArtifact): Promise<void> {
        try {
            ...
            console.error(`Error creating FullArtifact item ${item.name.rus}:`, error);
            throw error;
        }
    }
    ...
    async updateItem(item: FullArtifact): Promise<void> {
        try {
            ...
            console.error(`Error updating FullArtifact item ${item.name.rus}:`, error);
            throw error;
        }
    }
    ...
    async mapSqlValues(values: SqlValue[]): Promise<FullArtifact> {
        try {
            ...
            console.error('Error mapping SQL values to FullArtifact:', error);
            throw error;
        }
    }
}
