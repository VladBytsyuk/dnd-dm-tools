...
export class FullMonsterSqlTableDao extends Dao<FullMonster, any> {
    ...
    async createItem(item: FullMonster): Promise<void> {
        try {
            ...
            console.error(`Error creating FullMonster item ${item.name.rus}:`, error);
            throw error;
        }
    }
    ...
    async updateItem(item: FullMonster): Promise<void> {
        try {
            ...
            console.error(`Error updating FullMonster item ${item.name.rus}:`, error);
            throw error;
        }
    }
    ...
    async mapSqlValues(sqlValues: SqlValue[]): Promise<FullMonster> {
        try {
            ...
            console.error('Error mapping SQL values for FullMonster:', error);
            throw error;
        }
    }
}
