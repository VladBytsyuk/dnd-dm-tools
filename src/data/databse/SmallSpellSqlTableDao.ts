...
export class SmallSpellSqlTableDao extends Dao<SmallSpell, SpellbookFilters> {
    ...
    async createItem(item: SmallSpell): Promise<void> {
        try {
            ...
            console.error(`Error creating SmallSpell item ${item.name.rus}:`, error);
            throw error;
        }
    }
    ...
    async filterByFilters(filters: SpellbookFilters): Promise<WhereClauseData> {
        try {
            ...
            console.error('Error filtering SmallSpell by filters:', error);
            throw error;
        }
    }
    ...
    async updateItem(item: SmallSpell): Promise<void> {
        try {
            ...
            console.error(`Error updating SmallSpell item ${item.name.rus}:`, error);
            throw error;
        }
    }
    ...
    async mapSqlValues(sqlValues: SqlValue[]): Promise<SmallSpell> {
        try {
            ...
            console.error('Error mapping SQL values to SmallSpell:', error);
            throw error;
        }
    }
}
